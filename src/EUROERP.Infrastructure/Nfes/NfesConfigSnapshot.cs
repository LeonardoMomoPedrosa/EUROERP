...
public sealed class NfesConfigSnapshot
{
    ...
    public string EmitLogradouro { get; init; } = "";
    public string EmitNumero { get; init; } = "";
    public string EmitComplemento { get; init; } = "";
    public string EmitBairro { get; init; } = "";
    public string EmitMunicipio { get; init; } = "";
    public string EmitSiglaUf { get; init; } = "SP";
    public string EmitCep { get; init; } = "";
    public string EmitTelefone { get; init; } = "";
    ...
    public static NfesConfigSnapshot From(IReadOnlyDictionary<string, string> db, IConfiguration configuration)
    {
        ...
        return new NfesConfigSnapshot
        {
            ...
            EmitLogradouro = Pick(NfesConfigCodes.EmitLogradouro, "Nfes:EmitLogradouro", configuration["NFe:EmitLogradouro"] ?? ""),
            EmitNumero = Pick(NfesConfigCodes.EmitNumero, "Nfes:EmitNumero", configuration["NFe:EmitNumero"] ?? ""),
            EmitComplemento = Pick(NfesConfigCodes.EmitComplemento, "Nfes:EmitComplemento", configuration["NFe:EmitComplemento"] ?? ""),
            EmitBairro = Pick(NfesConfigCodes.EmitBairro, "Nfes:EmitBairro", configuration["NFe:EmitBairro"] ?? ""),
            EmitMunicipio = Pick(NfesConfigCodes.EmitMunicipio, "Nfes:EmitMunicipio", configuration["NFe:EmitMunicipio"] ?? ""),
            EmitSiglaUf = Pick(NfesConfigCodes.EmitSiglaUf, "Nfes:EmitSiglaUf", configuration["NFe:Siglauf"] ?? "SP"),
            EmitCep = Pick(NfesConfigCodes.EmitCep, "Nfes:EmitCep", configuration["NFe:EmitCep"] ?? ""),
            EmitTelefone = Pick(NfesConfigCodes.EmitTelefone, "Nfes:EmitTelefone", configuration["NFe:EmitTelefone"] ?? ""),
    ...
    public NfesConfigDto ToDto(bool certPasswordConfigured)
    {
        return new NfesConfigDto
        {
            ...
            EmitCnpj = EmitCnpj,
            EmitIMun = EmitIMun,
            EmitLogradouro = EmitLogradouro,
            EmitNumero = EmitNumero,
            EmitComplemento = EmitComplemento,
            EmitBairro = EmitBairro,
            EmitMunicipio = EmitMunicipio,
            EmitSiglaUf = EmitSiglaUf,
            EmitCep = EmitCep,
            EmitTelefone = EmitTelefone,
