...
public class NfesConfigService : INfesConfigService, INfesConfigProvider
{
    ...
    public async Task SaveConfigAsync(NfesConfigDto config, CancellationToken cancellationToken = default)
    {
        var values = new Dictionary<string, string>
        {
            ...
            [NfesConfigCodes.EmitLogradouro] = config.EmitLogradouro.Trim(),
            [NfesConfigCodes.EmitNumero] = config.EmitNumero.Trim(),
            [NfesConfigCodes.EmitComplemento] = config.EmitComplemento.Trim(),
            [NfesConfigCodes.EmitBairro] = config.EmitBairro.Trim(),
            [NfesConfigCodes.EmitMunicipio] = config.EmitMunicipio.Trim(),
            [NfesConfigCodes.EmitSiglaUf] = config.EmitSiglaUf.Trim(),
            [NfesConfigCodes.EmitCep] = config.EmitCep.Trim(),
            [NfesConfigCodes.EmitTelefone] = config.EmitTelefone.Trim(),
